export const configMapel = {
  path: "setting/academic/subject?perPage=50",
  ...
  dialogErrorMessages: {
    ...
    mataPelajaranRequired: "Mata Pelajaran wajib diisi",
  },
  ...
  dataMapel: {
    simpleFillFirst: {
      ...
      mataPelajaran: "AUTOTEST Manajemen Project",
      kodeMapel: "MTK120-AUTOTEST",
    },
    simpleFillNoKode: {
      instansi: [
        "Academy QA Engineer",
      ...
      mataPelajaran: "AUTOTEST NoKode Manajemen Project",
      kodeMapel: "",
    },
    ...
    multiFill: {
      matematika: {
        ...
        mataPelajaran: "AUTOTEST Matematika",
        kodeMapel: "MTK122-AUTOTEST",
      },
      ipa: {
        instansi: [
          "Academy QA Engineer",
        ...
        mataPelajaran: "AUTOTEST IPA",
        kodeMapel: "IPA123-AUTOTEST",
      },
      ips: {
        instansi: [
          "Academy QA Engineer",
        ...
        mataPelajaran: "AUTOTEST IPS",
        kodeMapel: "IPS124-AUTOTEST",
      },
    },

    fillDifferentInstansi: {
      instansi: [
        "Academy QA Engineer",
        "Sekolah Digital Indonesia",
        "Yayasan New School",
      ],
      mataPelajaran: "AUTOTEST Geofisika",
      kodeMapel: "MTK125-AUTOTEST",
    },
    ...
    fillAutoTrimmed: {
      ...
      mataPelajaran: "   AUTOTEST Sosiologi   ",
      kodeMapel: "MTK127-AUTOTEST",
    },
    ...
    formFillTwice: {
      form1: {
        ...
        mataPelajaran: "AUTOTEST CompSci 1",
        kodeMapel: "MTK127-COMPSCI-AUTOTEST",
      },
      form2: {
        instansi: [
          "Academy QA Engineer",
        ...
        mataPelajaran: "AUTOTEST CompSci 2",
        kodeMapel: "MTK127-COMPSCI2-AUTOTEST",
      },
    },
  },
};
